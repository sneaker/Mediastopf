...
import ch.nomoresecrets.mediastopf.server.ui.tables.ExportTable;
import ch.nomoresecrets.mediastopf.server.ui.tables.ImportTable;
...
public class MediaStopfServer extends JFrame {
	...
	public static final String UIIMAGELOCATION = "/ch/nomoresecrets/mediastopf/server/ui/images/";
	...
	private void addRunningTaskButtons(JPanel panel) {
		...
		int width = 100;
		int height = 25;
		final String[] buttonText = { cancel };
		final Rectangle cancelBounds = new Rectangle(x, y, width, height);
		final Rectangle[] bounds = { cancelBounds };
		final int cancelAcc = KeyEvent.VK_C;
		final int[] mnemonic = { cancelAcc };
