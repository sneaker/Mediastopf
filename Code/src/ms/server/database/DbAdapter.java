...
public class DbAdapter {
	...
	public static Mediensammlung getMediensammlung(int MediensammlungId) {
		String sql = "select * from Mediensammlung where id = " + MediensammlungId;
		List<Mediensammlung> myList = ActiveRecordManager.getObjectList(sql, Mediensammlung.class);
		if(myList.isEmpty()) return null;
		else return myList.get(0);
	}
	...
	public static List<Mediensammlung> getMediensammlungList(Auftrag myAuftrag) {
		String sql = "select * from Mediensammlung where fk_Auftrag = " + myAuftrag.getID();
		List<Mediensammlung> myList = ActiveRecordManager.getObjectList(sql, Mediensammlung.class);
		if(myList.isEmpty()) return null;
		else return myList;
	}
	...
	public static List<ImportMedium> getImportMediumList(Mediensammlung myMediensammlung) {
		String sql = "select * from ImportMedium where fk_Mediensammlung = " + myMediensammlung.getID();
		List<ImportMedium> myList = ActiveRecordManager.getObjectList(sql, ImportMedium.class);
		if(myList.isEmpty()) return null;
		else return myList;
	}
	
	public static List<ImportMedium> getImportMediumList(Einlesegeraet myEinlesegeraet) {
		String sql = "select * from ImportMedium where fk_Einlesegeraet = " + myEinlesegeraet.getID();
		List<ImportMedium> myList = ActiveRecordManager.getObjectList(sql, ImportMedium.class);
		if(myList.isEmpty()) return null;
		else return myList;
	}
	...
	public static Sammelstation getSammelstation(int SammelstationId ) {
		String sql = "select * from Sammelstation WHERE id = " + SammelstationId;
		List<Sammelstation> myList = ActiveRecordManager.getObjectList(sql, Sammelstation.class);
		if(myList.isEmpty()) return null;
		else return myList.get(0);
	}
	...
	public static Einlesestation getEinlesestation(int EinlesestationId ) {
		String sql = "select * from Einlesestation WHERE id = " + EinlesestationId;
		List<Einlesestation> myList = ActiveRecordManager.getObjectList(sql, Einlesestation.class);
		if(myList.isEmpty()) return null;
		else return myList.get(0);
	}
	
	public static List<Einlesestation> getEinlesestation(Sammelstation mySammelstation ) {
		String sql = "select * from Einlesestation WHERE fk_Sammelstation = " + mySammelstation.getID();
		List<Einlesestation> myList = ActiveRecordManager.getObjectList(sql, Einlesestation.class);
		if(myList.isEmpty()) return null;
		else return myList;
	}
	...
	public static Einlesegeraet getEinlesegeraet(int EinlesegeraetId ) {
		String sql = "select * from Einlesegeraet WHERE id = " + EinlesegeraetId;
		List<Einlesegeraet> myList = ActiveRecordManager.getObjectList(sql, Einlesegeraet.class);
		if(myList.isEmpty()) return null;
		else return myList.get(0);
	}
	
	public static List<Einlesegeraet> getEinlesegeraet(Einlesestation myEinlesestation) {
		String sql = "select * from Einlesegeraet WHERE fk_Einlesestation = " + myEinlesestation.getID();
		List<Einlesegeraet> myList = ActiveRecordManager.getObjectList(sql, Einlesegeraet.class);
		if(myList.isEmpty()) return null;
		else return myList;
	}
